...
from app.interfaces.schema.file import FileWriteRequest, FileReadRequest, FileReplaceRequest, FileSearchRequest, \
...
from app.models.file import FileReadResult, FileWriteResult, FileReplaceResult, FileSearchResult, FileFindResult, \
    FileCheckResult, FileDeleteResult
