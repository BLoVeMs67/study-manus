...
from app.interfaces.schema.shell import ShellReadRequest, ShellExecuteRequest, ShellWaitRequest, ShellWriteRequest, \
    ShellKillRequest
from app.interfaces.service_dependencies import get_shell_service
from app.models.shell import ShellWaitResult, ShellWriteResult, ShellReadResult, \
    ShellKillResult, ShellExecuteResult
...
async def write_shell_input(
    ...
    result = await shell_service.wait_shell_input(
        session_id=request.session_id,
